...
const Footer: FC<FooterProps> = ({}) => {
  const { currentPage, handlePageChange } = useDashboard();
  return (
    <div className="fixed z-50 w-full h-20 max-w-lg -translate-x-1/2 bottom-4 left-1/2 dark:bg-slate-950">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        >
          <svg
            className={`w-8 h-8 text-gray-800 ${
              currentPage === "goals" ? "dark:text-white" : "dark:text-gray-400"
            } group-hover:text-slate-950 dark:group-hover:text-slate-950`}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            width="18"
        ...
        <div className="flex items-center justify-center">
          ...
          >
            <svg
              className={`w-6 h-6 ${
                currentPage === "log" ? "dark:text-white" : "dark:text-gray-400"
              } group-hover:text-slate-950 dark:group-hover:text-slate-950`}
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
